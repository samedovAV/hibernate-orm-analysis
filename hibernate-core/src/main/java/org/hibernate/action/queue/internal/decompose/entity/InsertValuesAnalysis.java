...
public class InsertValuesAnalysis implements ValuesAnalysis, TableInclusionChecker {
	private final Set<TableDescriptor> tablesWithNonNullValues = new IdentitySet<>();

	public InsertValuesAnalysis(GraphEntityMutationTarget mutationTarget, Object[] values) {

...
public class ChecksAnnotation implements Checks, RepeatableContainer<Check> {
	 ...
	 */
	public ChecksAnnotation(ModelsContext modelContext) {
	}

	/**
	 * Used in creating annotation instances from JDK variant
	 */
	public ChecksAnnotation(Checks annotation, ModelsContext modelContext) {
	 ...
	 */
	public ChecksAnnotation(Map<String, Object> attributeValues, ModelsContext modelContext) {

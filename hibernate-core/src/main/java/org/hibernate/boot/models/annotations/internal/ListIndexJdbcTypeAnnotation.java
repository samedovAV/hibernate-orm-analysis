...
public class ListIndexJdbcTypeAnnotation implements ListIndexJdbcType {
	 ...
	 */
	public ListIndexJdbcTypeAnnotation(ModelsContext modelContext) {
	}

	/**
	 * Used in creating annotation instances from JDK variant
	 */
	public ListIndexJdbcTypeAnnotation(ListIndexJdbcType annotation, ModelsContext modelContext) {
	 ...
	 */
	public ListIndexJdbcTypeAnnotation(Map<String, Object> attributeValues, ModelsContext modelContext) {

...
public class MapKeyJdbcTypeAnnotation implements MapKeyJdbcType {
	 ...
	 */
	public MapKeyJdbcTypeAnnotation(ModelsContext modelContext) {
	}

	/**
	 * Used in creating annotation instances from JDK variant
	 */
	public MapKeyJdbcTypeAnnotation(MapKeyJdbcType annotation, ModelsContext modelContext) {
	 ...
	 */
	public MapKeyJdbcTypeAnnotation(Map<String, Object> attributeValues, ModelsContext modelContext) {

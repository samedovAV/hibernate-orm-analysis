...
public class NamedStatementJpaAnnotation implements NamedStatement {
	private String name;
	 ...
	 */
	public NamedStatementJpaAnnotation(ModelsContext modelContext) {
	 ...
	 */
	public NamedStatementJpaAnnotation(NamedStatement annotation, ModelsContext modelContext) {
		this.name = annotation.name();
		this.statement = annotation.statement();
		this.hints = extractJdkValue( annotation, JpaAnnotations.NAMED_STATEMENT, "hints", modelContext );
	}

	/**
	 * Used in creating annotation instances from Jandex variant
	 */
	public NamedStatementJpaAnnotation(Map<String, Object> attributeValues, ModelsContext modelContext) {

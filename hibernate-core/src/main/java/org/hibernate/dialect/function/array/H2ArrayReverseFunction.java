 ...
 * functions to achieve array reversal.
 */
public class H2ArrayReverseFunction extends AbstractArrayReverseFunction {

	private final int maximumArraySize;

	public H2ArrayReverseFunction(int maximumArraySize) {
	...
	public void render(
		...
		arrayExpression.accept( walker );
		sqlAppender.append( ",i.idx) order by i.idx desc) from system_range(1," );

 ...
 */
public class SybaseJtdsXmlAsStringJdbcType extends XmlAsStringJdbcType {

	public static final SybaseJtdsXmlAsStringJdbcType JTDS_VARCHAR_INSTANCE =
			new SybaseJtdsXmlAsStringJdbcType( SqlTypes.LONG32VARCHAR, null );
	public static final SybaseJtdsXmlAsStringJdbcType JTDS_NVARCHAR_INSTANCE =
			new SybaseJtdsXmlAsStringJdbcType( SqlTypes.LONG32NVARCHAR, null );
	public static final SybaseJtdsXmlAsStringJdbcType JTDS_CLOB_INSTANCE =
			new SybaseJtdsXmlAsStringJdbcType( SqlTypes.CLOB, null );
	public static final SybaseJtdsXmlAsStringJdbcType JTDS_INSTANCE =
			new SybaseJtdsXmlAsStringJdbcType( SqlTypes.NCLOB, null );

	public SybaseJtdsXmlAsStringJdbcType(int ddlTypeCode, EmbeddableMappingType embeddableMappingType) {
	...
	public AggregateJdbcType resolveAggregateJdbcType(
		...
		return new SybaseJtdsXmlAsStringJdbcType( getDdlTypeCode(), mappingType );
	}

	@Override
	@Prove(complexity = Complexity.O_1, n = "", count = {})
	public String toString() {
		return "SybaseJtdsXmlAsStringJdbcType";
	}
	...
	public JdbcType resolveIndicatedType(JdbcTypeIndicators indicators, JavaType<?> domainJtd) {
		...
		if ( getEmbeddableMappingType() == null ) {
			...
			if ( needsLob( indicators ) ) {
				return new SybaseJtdsXmlAsStringJdbcType(
	...
	public <X> ValueBinder<X> getBinder(JavaType<X> javaType) {
		...
		return new BasicBinder<>( javaType, this ) {
			...
			@Prove(complexity = Complexity.O_1, n = "", count = {})
			private SybaseJtdsXmlAsStringJdbcType getXmlAsStringJdbcType() {
				return (SybaseJtdsXmlAsStringJdbcType) getJdbcType();
			}
